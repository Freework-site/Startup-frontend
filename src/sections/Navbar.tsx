...
export default function Navbar() {
    ...
    return <section className="py-4 lg:py-8 sticky top-0 z-50">
        <div className="container max-w-5xl mx-auto px-4">
            <div className="grid grid-cols-2 lg:grid-cols-3 border border-black/15 rounded-full px-4 p-2 md:pr-2 items-center bg-neutral-100/70 backdrop-blur   ">
                <div>
                    <Image src={logoImage} alt="Startup Logo" className="h-9 w-auto md:h-auto" />
                </div>
                ...
                <div className="flex justify-end gap-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        ...
                        <line x1="3" y1="6" x2="21" y2="6" className={twMerge(isOpen && 'rotate-45 -translate-y-1')}></line>
                        <line x1="3" y1="12" x2="21" y2="12" className={twMerge(isOpen && 'opacity-0')}></line>
                        <line x1="3" y1="18" x2="21" y2="18" className={twMerge(isOpen && 'rotate-45 -translate-y-1')}></line>
                    </svg>
